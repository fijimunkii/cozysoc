...
func TestDiagnosticPreviewRoundTripAndStrictParams(t *testing.T) {
	handler := &diagnosticPreviewTestHandler{preview: api.DiagnosticPreview{SchemaVersion: 1, GeneratedAt: time.Unix(1_800_000_000, 0).UTC()}}
	...
	if err := json.Unmarshal(raw, &got); err != nil || got.SchemaVersion != 1 {
