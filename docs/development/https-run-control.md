...
and drains it before closing storage. The native [consent protocol](https-consent.md)
is available only with the macOS controller’s explicit `--experimental-https-checks`
flag. No browser execution or scheduler is added.
