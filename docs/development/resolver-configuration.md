...
save/list/retire and preview operations. The authenticated local browser also exposes fixed save and retire routes for the same controller-owned settings. [Native execution](resolver-consent.md)
