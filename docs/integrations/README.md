...
- [`../development/adguard-readonly.md`](../development/adguard-readonly.md) — candidate native AdGuard Home external connection, scoped one-shot DNS evidence, and remaining device-history/coverage work.
