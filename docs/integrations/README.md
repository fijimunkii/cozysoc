...
- [`../development/adguard-readonly.md`](../development/adguard-readonly.md) — candidate native AdGuard Home external connection, read boundary, and remaining DNS observation work.
