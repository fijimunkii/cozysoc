...
- [`../development/opnsense-readonly.md`](../development/opnsense-readonly.md) — candidate native OPNsense 26.7.4 external connection and explicitly reviewed, scoped one-shot neighbor evidence; owned-lab gates remain and there is no support claim.
