...
EXPECTED = {"TestMACOSGatewayLab"} | {
    ...
    for name in ("route", "resolver-route", "dns-answer", "dns-nxdomain", "dns-silent", "dns-wrong-id", "dns-cancel", "dns-source-loss", "reply", "silent", "wrong-nonce", "cancel", "source-loss", "shutdown", "native-session")
}
