...
- Storage can read gateway, resolver and HTTPS history in one bounded snapshot. Connecting HTTPS to retained diagnosis remains follow-up work; the current diagnosis still compares gateway and resolver evidence.
