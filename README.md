...
- Scoped Device Watch merge/undo controls in the native CLI and local browser can correct duplicate identities without rewriting retained observations; evidence detail discloses the original association.
