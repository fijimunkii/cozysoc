...
- A candidate native OPNsense 26.7.4 connection can verify router version over a protected, status-only external API link. It does not yet import neighbors, cover all network traffic, or establish router support.
