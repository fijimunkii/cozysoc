...
- HTTPS settings and native review disclose the exact request, identity, route, data limits and privacy impact. Internal TLS/HTTP and native TCP candidates produce normalized measurements with response timing; HTTPS execution remains disabled pending audited run control, consent and integrated lab evidence.
