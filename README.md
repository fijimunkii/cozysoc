...
- Scoped native Device Watch merge/undo commands can correct duplicate device identities without rewriting retained observations; the browser evidence view discloses the original association.
